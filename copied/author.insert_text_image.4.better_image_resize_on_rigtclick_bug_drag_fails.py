...
<body><p>&nbsp;</p></body>
    ...
    def on_webview_load(self, webview, load_event):
        if load_event == WebKit.LoadEvent.FINISHED:
            ...
            # Enhanced script with removed handles and added border options
            enhanced_script = """
                (function() {
                    ...
                    // Function to make elements draggable and resizable via context menu
                    function makeElementInteractive(element) {
                        ...
                        // Expose methods for context menu
                    ...
                    // Context menu functionality with border options
