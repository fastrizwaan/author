...
<body><p>&nbsp;</p></body>
    ...
    def on_webview_load(self, webview, load_event):
        if load_event == WebKit.LoadEvent.FINISHED:
            ...
            # Enhanced script with corrected drag-and-drop
            enhanced_script = """
                (function() {
                    ...
                    document.body.addEventListener('contextmenu', function(e) {
                        // Get the closest relevant element
                    ...
                    // Also need to modify the textbox insertion code to ensure proper initialization
