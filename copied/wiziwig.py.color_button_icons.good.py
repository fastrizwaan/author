...
<body><p><br></p></body>
        ...
        text_color_btn = Gtk.Button(child=text_color_icon)
        ...
        bg_color_btn = Gtk.Button(child=bg_color_icon)
    ...
    def on_text_color_clicked(self, btn):
        ...
        color_dialog.set_with_alpha(False)  # Optional: Disable alpha channel if not needed
        color_dialog.choose_rgba(self, None, None, self.on_text_color_dialog_response, btn)
    ...
    def on_bg_color_clicked(self, btn):
        ...
        color_dialog.set_with_alpha(False)  # Optional: Disable alpha channel if not needed
        color_dialog.choose_rgba(self, None, None, self.on_bg_color_dialog_response, btn)
