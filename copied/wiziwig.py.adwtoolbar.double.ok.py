...
# Main layout
        ...
        # Toolbar groups (already defined in your code)
        ...
        # Create toolbar1_flowbox for file, edit, view groups
        toolbar1_flowbox = Gtk.FlowBox()
        toolbar1_flowbox.set_selection_mode(Gtk.SelectionMode.NONE)
        toolbar1_flowbox.set_max_children_per_line(100)
        toolbar1_flowbox.set_homogeneous(False)
        toolbar1_flowbox.add_css_class("toolbar-container")
        toolbar1_flowbox.insert(file_group, -1)
        toolbar1_flowbox.insert(edit_group, -1)
        toolbar1_flowbox.insert(view_group, -1)

        # Create toolbar2_flowbox for text formatting, starting with text_style_group
        toolbar2_flowbox = Gtk.FlowBox()
        toolbar2_flowbox.set_selection_mode(Gtk.SelectionMode.NONE)
        toolbar2_flowbox.set_max_children_per_line(100)
        toolbar2_flowbox.set_homogeneous(False)
        toolbar2_flowbox.add_css_class("toolbar-container")
        toolbar2_flowbox.insert(text_style_group, -1)
        toolbar2_flowbox.insert(text_format_group, -1)
        toolbar2_flowbox.insert(list_group, -1)
        toolbar2_flowbox.insert(color_group, -1)

        # Add toolbars as top bars
        toolbar_view.add_top_bar(toolbar1_flowbox)
        toolbar_view.add_top_bar(toolbar2_flowbox)
