...
############################### 1050 - 1682 ########################################
    ...
    def create_script_row(self, script_key, script_data):
        ...
        if self.icon_view:
            ...
            # top_box.set_valign(Gtk.Align.FILL)
            # top_box.set_halign(Gtk.Align.FILL)
            #top_box.set_size_request(150, 100)
            ...
            #container.set_size_request(100, 140)
