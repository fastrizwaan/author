...
class WebEditor(Adw.ApplicationWindow):
    def __init__(self, application):
        ...
        # Size dropdown with point sizes
        self.size_map = {
            "6": "1",    # xx-small
            "7": "1",
            "8": "1",
        ...
        for size in ["6", "7", "8", "9", "10", "10.5", "11", "12", "13", "14", "15", "16", 
                    "18", "20", "21", "22", "24", "26", "28", "32", "36", "40", "42", 
                    "44", "48", "54", "60", "66", "72", "80", "88", "96"]:
            size_store.append(size)
        self.size_dropdown = Gtk.DropDown(model=size_store)
        self.size_dropdown.set_selected(6)  # Default to 11pt
    ...
    def on_font_size_changed(self, dropdown, _pspec):
        pt_size = dropdown.get_selected_item().get_string()
        webkit_size = self.size_map[pt_size]  # Convert to WebKit size index
