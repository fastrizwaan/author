...
###################### 0.95
    ...
    def create_script_row(self, script_key, script_data):
        ...
        if self.icon_view:
            ...
            # Top: Icon (centered)
            icon = self.load_icon(script, 128, 128, 10)
            if icon:
                icon_container = Gtk.Box()
                icon_container.add_css_class("rounded-icon")
                icon_image = Gtk.Image.new_from_paintable(icon)
            ...
            # Bottom: Container for label or buttons
            label_button_box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=6)
            label_button_box.set_halign(Gtk.Align.CENTER)
            ...
            #main_label.set_halign(Gtk.Align.CENTER)
            main_label.set_markup(title_text)
            label_button_box.append(main_label)

            # Button box (initially not added to the layout)
            button_box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=6)
            play_button = Gtk.Button(icon_name="media-playback-start-symbolic", tooltip_text="Play")
            play_button.add_css_class("flat")
            play_button.set_size_request(60, 34)
            play_button.set_opacity(1)  # Always visible when in button mode
            play_button.set_sensitive(True)

            options_button = Gtk.Button(icon_name="emblem-system-symbolic", tooltip_text="Options")
            options_button.add_css_class("flat")
            options_button.set_size_request(34, 34)
            options_button.set_opacity(1)  # Always visible when in button mode
            ...
            self.script_ui_data[script_key] = {
                ...
                'is_running': False,
                'script_path': script,
                'showing_buttons': False  # Track whether buttons are shown
            }
            ...
            label_button_box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=6)
            label_button_box.set_valign(Gtk.Align.CENTER)
            label_button_box.set_halign(Gtk.Align.START)
            label_button_box.set_hexpand(True)

            # Label (initially visible)
            main_label = Gtk.Label()
            main_label.set_wrap(True)
            main_label.set_ellipsize(Pango.EllipsizeMode.FILL)
    ...
    def toggle_overlay_buttons(self, script_key):
        ...
        for key, ui in self.script_ui_data.items():
            if key != script_key and ui.get('showing_buttons', False):
                ...
                ui['label_button_box'].append(ui['label'])
        ...
        if showing_buttons:
            ...
            label_button_box.append(ui['label'])
            ui['showing_buttons'] = False
            ui['row'].remove_css_class("blue")
        else:
            # Switch to buttons
            label_button_box.remove(ui['label'])
...
############## new
    def create_script_row(self, script_key, script_data):
        ...
        if self.icon_view:
            ...
            # Top: Icon (centered)
            icon = self.load_icon(script, 96, 96, 10)
            icon_container = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=600)
            icon_container.set_hexpand(True)  # Expand horizontally to allow centering
            icon_container.set_halign(Gtk.Align.CENTER)  # Center the icon horizontally
            icon_container.set_valign(Gtk.Align.CENTER)
            if icon:
                icon_container.add_css_class("rounded-icon")
                icon_image = Gtk.Image.new_from_paintable(icon)
                icon_image.set_pixel_size(96)
                icon_image.set_halign(Gtk.Align.CENTER)  # Center within its container
            ...
            # container.set_size_request(182,150)
            ...
            spacer = Gtk.Box()
            spacer.set_hexpand(True)  # Expand to fill available space
            spacer.set_vexpand(True)
            # Container for label or buttons
            label_button_box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=6)
            label_button_box.set_valign(Gtk.Align.CENTER)
            label_button_box.set_halign(Gtk.Align.FILL)  # Align to the right
            ...
            label_button_box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=6)
            label_button_box.set_valign(Gtk.Align.CENTER)
            #label_button_box.set_halign(Gtk.Align.END)
            label_button_box.set_halign(Gtk.Align.FILL)
            
            # Button box Label
            main_label = Gtk.Label()
            main_label.set_wrap(True)
            main_label.set_max_width_chars(40)
            main_label.set_lines(1)
            main_label.set_ellipsize(Pango.EllipsizeMode.END)
            main_label.set_halign(Gtk.Align.CENTER)
            main_label.set_valign(Gtk.Align.CENTER)
            main_label.set_markup(title_text)
            ...
            # label_play_button = Gtk.Button(icon_name="media-playback-start-symbolic", tooltip_text="Play")
            # label_play_button.set_size_request(60, -1)
            # label_play_button.set_opacity(1)
            # label_play_button.set_sensitive(True)

            # label_options_button = Gtk.Button(icon_name="emblem-system-symbolic", tooltip_text="Options")
            # label_options_button.set_size_request(1, 1)
            # label_options_button.set_opacity(0)
            # label_options_button.set_sensitive(True)

            label_button_box.append(main_label)
            label_button_box.append(spacer)  # Add spacer before label_button_box
            # label_button_box.append(label_play_button)
            #label_button_box.append(label_options_button)
##########################
            ...
            box_main_label.set_max_width_chars(40)
            #box_main_label.set_lines(1)
            box_main_label.set_ellipsize(Pango.EllipsizeMode.END)
            box_main_label.set_halign(Gtk.Align.CENTER)
            box_main_label.set_valign(Gtk.Align.CENTER)
            box_main_label.set_markup(title_text)
            box_main_label.set_max_width_chars(10)
            box_main_label.set_halign(Gtk.Align.FILL)
            #label_button_box.append(main_label)
            ...
            button_box.append(spacer)  # Add spacer before label_button_box
            button_box.append(play_button)
            button_box.append(options_button)
...
########### NEW 2
    def create_script_row(self, script_key, script_data):
        ...
        if self.icon_view:
            ...
            # Create label_box to hold the main_label
            label_box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=0)
            label_box.set_halign(Gtk.Align.CENTER)  # Center the label_box within label_button_box
            main_label = Gtk.Label()
            main_label.set_wrap(True)
            main_label.set_max_width_chars(40)
            main_label.set_lines(2)
            main_label.set_ellipsize(Pango.EllipsizeMode.END)
            main_label.set_halign(Gtk.Align.CENTER)  # Center the label text
            main_label.set_valign(Gtk.Align.CENTER)
            main_label.set_markup(title_text)
            label_box.append(main_label)
            ...
            self.script_ui_data[script_key] = {
                ...
                'play_button': play_button,
                'options_button': options_button,
                'label_box': label_box,  # Store label_box instead of label
                'button_box': button_box,
                'label_button_box': label_button_box,
                'is_running': False,
                'script_path': script,
        ...
        if not self.icon_view:
            ...
            # Container for label or buttons
            label_button_box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=6)
            label_button_box.set_hexpand(True)  # Allow it to fill available space
            label_button_box.set_valign(Gtk.Align.CENTER)
            ...
            main_label.set_halign(Gtk.Align.START)  # Left-align the label
            main_label.set_wrap(True)
            main_label.set_max_width_chars(25)
            main_label.set_ellipsize(Pango.EllipsizeMode.END)
            main_label.set_markup(title_text)
            ...
            spacer = Gtk.Box()
            spacer.set_hexpand(True)  # Spacer pushes buttons to the right
    ...
    def toggle_overlay_buttons(self, script_key):
        ...
        for key, ui in self.script_ui_data.items():
            if key != script_key and ui.get('showing_buttons', False):
                ui['label_button_box'].remove(ui['button_box'])
                ui['label_button_box'].append(ui['label_box'])  # Use label_box
                ui['showing_buttons'] = False
                ui['row'].remove_css_class("blue")
        ...
        if showing_buttons:
            # Switch back to label
            label_button_box.remove(ui['button_box'])
            label_button_box.append(ui['label_box'])  # Append label_box
            ui['showing_buttons'] = False
            ui['row'].remove_css_class("blue")
        else:
            # Switch to buttons
            label_button_box.remove(ui['label_box'])  # Remove label_box
            label_button_box.append(ui['button_box'])
            ui['showing_buttons'] = True
            ui['row'].add_css_class("blue")
    ...
    def create_script_row(self, script_key, script_data):
        ...
        if self.icon_view:
            ...
            if icon:
                ...
                icon_image = Gtk.Image()
                icon_container.append(icon_image)
            icon_container.set_margin_top(10)
            ...
            main_label = Gtk.Label()
            main_label.set_max_width_chars(25)
            #main_label.set_wrap(True)  # Disable wrapping
            main_label.set_lines(2)  # Limit to one line
            main_label.set_ellipsize(Pango.EllipsizeMode.END)  # Ellipsize long text
            #main_label.set_halign(Gtk.Align.CENTER)
            main_label.set_valign(Gtk.Align.CENTER)
            main_label.set_markup(title_text)
            main_label.set_tooltip_text(str(script_data.get('progname', script.stem)))  # Full text tooltip
            label_box.append(main_label)
            label_button_box.append(label_box)
            label_button_box.set_size_request(-1, 40)
            label_button_box.set_margin_top(1)
            ...
            options_button = Gtk.Button(icon_name="emblem-system-symbolic", tooltip_text="Options")
            options_button.add_css_class("flat")
            options_button.set_size_request(36, 34)
            options_button.set_opacity(1)
            options_button.set_sensitive(True)

            button_box.append(options_button)
            button_box.append(play_button)
            button_box.set_size_request(100, 40)
...
################## will this work?
    def process_ended(self, script_key):
        ...
        # Handle button visibility using toggle_overlay_buttons if buttons were showing
        if ui_state.get('showing_buttons', False):
            self.toggle_overlay_buttons(script_key)  # This will hide buttons and reset to label
        else:
            # If buttons weren't showing, just ensure they're reset
            if play_button and options_button:
                play_button.set_opacity(1)  # Reset to visible but not active
                options_button.set_opacity(1)
                play_button.set_sensitive(True)
                options_button.set_sensitive(True)
