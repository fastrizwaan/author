...
<body><p>&nbsp;</p></body>
    ...
    def on_webview_load(self, webview, load_event):
        if load_event == WebKit.LoadEvent.FINISHED:
            ...
            # Enhanced script with content change detection, styles, and drag-and-drop
            enhanced_script = """
                (function() {
                    ...
                    document.body.addEventListener('dragstart', function(e) {
                        ...
                        if (target.classList.contains('textbox') || target.classList.contains('resizable-image')) {
                            ...
                            target.dataset.dragX = e.clientX - parseInt(target.style.left || '0');
                            target.dataset.dragY = e.clientY - parseInt(target.style.top || '0');
                        }
                    });
                    ...
                    document.body.addEventListener('drag', function(e) {
                        ...
                        if (target && e.clientX > 0 && e.clientY > 0) {
                            target.style.left = (e.clientX - target.dataset.dragX) + 'px';
                            target.style.top = (e.clientY - target.dataset.dragY) + 'px';
                        }
                    });
