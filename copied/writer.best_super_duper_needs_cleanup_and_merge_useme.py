...
<body><p></p></body>
    ...
    def update_formatting_ui(self, state):
        ...
        # Font size
        font_size_str = state.get('fontSize', '11')
        try:
            font_size = int(font_size_str)
        except ValueError:
            font_size = 11
        size_mapping = {1: "6", 2: "7", 3: "8", 4: "9", 5: "10", 6: "10.5", 7: "11", 8: "12", 9: "13", 10: "14", 11: "15", 12: "16", 13: "18", 14: "20", 15: "21", 16: "22", 17: "24", 18: "26", 19: "28", 20: "32", 21: "36", 22: "40", 23: "42", 24: "44", 25: "48", 26: "54", 27: "60", 28: "66", 29: "72", 30: "80", 31: "88", 32: "96"}
        size_str = size_mapping.get(font_size, "11")
        size_store = self.size_dropdown.get_model()
        selected_index = 7  # Default to 11pt
...
#################################################################################
    def update_formatting_ui(self, state=None):
        ...
        # Font family (always update from self.current_font)
        font_store = self.font_dropdown.get_model()
        ...
        # Font size (always update from self.current_font_size)
        size_store = self.size_dropdown.get_model()
...
#######################################################################################  
            ...
            self.webview.evaluate_javascript("""
                (function() {
                    ...
                    const notifySelectionChange = debounce(function() {
                        ...
                        let computedStyle = range && range.startContainer.parentElement ? 
                        ...
                        const state = {
                            ...
                            strikethrough: document.queryCommandState('strikethrough'),
                            formatBlock: document.queryCommandValue('formatBlock') || 'p',
                            fontName: computedStyle.fontFamily.replace(/['"]/g, ''),
    ...
    def on_font_size_changed(self, dropdown, *args):
        if item := dropdown.get_selected_item():
            ...
            self.update_formatting_ui()  # Call without state
