...
<body><p>&nbsp;</p></body>
    ...
    def on_webview_load(self, webview, load_event):
        if load_event == WebKit.LoadEvent.FINISHED:
            ...
            # Enhanced script with improved drag, text wrapping, and restored context menu
            enhanced_script = """
                (function() {
                    ...
                    function makeInteractive(el) {
                        ...
                        el.addEventListener('mousedown', function(e) {
                            // Allow dragging when clicking on the element's background
                            if (e.target === el) {
                    ...
                    // Restore context menu on right-click
