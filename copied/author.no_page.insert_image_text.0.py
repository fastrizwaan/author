    ...
    def on_insert_textbox_clicked(self, btn):
        script = """
            (function() {
                ...
                textbox.style.left = '50px'; // Initial position
                textbox.style.top = '50px';

                // Insert at cursor or body
            ...
            enhanced_script = """
                (function() {
                    ...
                    style.textContent = `
                        ...
                        .resizable-image {
                            width: 200px; /* Explicit initial width */
                    ...
                    document.body.addEventListener('dragstart', function(e) {
                        ...
                        if (target.classList.contains('textbox') || target.classList.contains('resizable-image')) {
                            ...
                            setTimeout(() => target.style.display = 'none', 0); // Hide original during drag
                        }
                    });
                    ...
                    document.body.addEventListener('drop', function(e) {
                        ...
                        if (draggedElement) {
                            draggedElement.style.display = ''; // Restore visibility
                            ...
                            if (range) {
                                ...
                                // Fallback: append to body with position
                                draggedElement.style.left = e.clientX + 'px';
                                draggedElement.style.top = e.clientY + 'px';
