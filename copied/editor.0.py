...
class Editor(Adw.Application):
    def __init__(self):
        super().__init__(application_id="io.github.fastrizwaan.editor")
...
<body><p></p></body>
        ...
        format_group = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=0)
        ...
        toolbars_flowbox.insert(file_group, -1)
        toolbars_flowbox.insert(format_group, -1)
        toolbars_flowbox.insert(align_group, -1)
        ...
        file_group.append(self.dark_mode_btn)

        # Format group buttons
        ...
        format_group.append(heading_dropdown)
        ...
        format_group.append(self.font_dropdown)
        ...
        format_group.append(self.underline_btn)
    ...
    def update_title(self):
        ...
        if self.current_file and not self.is_new:
            ...
            title = f"{modified_marker}{base_name} – Editor"
        else:
            title = f"{modified_marker}Document {self.document_number} – Editor"
