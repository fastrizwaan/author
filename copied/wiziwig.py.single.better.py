...
<body><p><br></p></body>
        ...
        #toolbars_flowbox.set_homogeneous(False)
        toolbars_flowbox.add_css_class("toolbar-container")

        # Add groups to FlowBox (adjusted order: align_group before color_group)
        toolbars_flowbox.insert(file_group, -1)
        toolbars_flowbox.insert(edit_group, -1)
        toolbars_flowbox.insert(view_group, -1)
        toolbars_flowbox.insert(text_style_group, -1)
        toolbars_flowbox.insert(text_format_group, -1)
        toolbars_flowbox.insert(list_group, -1)
        toolbars_flowbox.insert(align_group, -1)  # Moved up
        toolbars_flowbox.insert(color_group, -1)  # Moved down
        ...
        # Populate align_group with buttons
