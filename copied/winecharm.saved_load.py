...
########################
    def show_save_user_dirs_dialog(self, script, script_key, button):
        ...
        scrolled.set_min_content_height(200)  # Ensure reasonable initial height
        
        # ListBox to hold directory checkboxes
    ...
    def on_add_directory(self, button, parent_dialog, wineprefix):
        ...
        def on_dir_response(dlg, result):
            try:
                ...
                # Validate path is within wineprefix
    ...
    # Keep existing save_file_dialog and related methods unchanged
...
#######################
    ...
    def load_user_dirs(self, script, script_key, backup_path):
        ...
        try:
            ...
            if backup_path.endswith('.sav.tar.zst'):
                extract_dir = wineprefix / "drive_c" / "users"
            else:  # .saved files
                extract_dir = wineprefix
            ...
            GLib.idle_add(self.show_info_dialog, "Loaded", 
                        f"User directory extracted to {extract_dir}")
