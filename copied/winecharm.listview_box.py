...
############################### 1050 - 1682 ########################################
    ...
    def create_script_row(self, script_key, script_data):
        ...
        if self.icon_view:
            ...
            container = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=4)  # Reduced spacing to 4
            ...
            # Icon (smaller size, left-aligned)
            ...
            # Button box for play and options buttons (right-aligned, smaller and tightly packed)
            button_box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=2)  # Reduced spacing to 2
