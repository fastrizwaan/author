...
class EditorWindow(Adw.ApplicationWindow):
    def __init__(self, **kwargs):
        ...
        self.css_provider.load_from_data(b"""
            ...
            /* Add spacing between toolbar groups */
            .toolbar-group {
                margin: 0 6px;
            }
...
<body><p><br></p></body>
        ...
        # Create a header bar with title centered
        ...
        # Create a FlowBox for the toolbars that will adapt to window size
        toolbars_container = Gtk.Box(orientation=Gtk.Orientation.VERTICAL)
        toolbars_container.add_css_class("toolbar-container")
        
        # Create flexible toolbar rows using CenterBox for proper alignment
        # Toolbar 1: File operations and editing
        toolbar1 = Adw.Clamp()
        toolbar1_box = Gtk.CenterBox()
        toolbar1_box.set_orientation(Gtk.Orientation.HORIZONTAL)
        
        # Left group: File operations
        file_group = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL)
        file_group.add_css_class("toolbar-group")
        file_group.set_spacing(2)
        
        # Center group: Edit operations
        edit_group = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL)
        edit_group.add_css_class("toolbar-group")
        edit_group.set_spacing(2)
        
        # Right group: View operations
        view_group = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL)
        view_group.add_css_class("toolbar-group")
        view_group.set_spacing(2)
        
        toolbar1_box.set_start_widget(file_group)
        toolbar1_box.set_center_widget(edit_group)
        toolbar1_box.set_end_widget(view_group)
        
        toolbar1.set_child(toolbar1_box)
        toolbars_container.append(toolbar1)
        
        # Add a separator between toolbar rows
        separator = Gtk.Separator(orientation=Gtk.Orientation.HORIZONTAL)
        toolbars_container.append(separator)
        
        # Toolbar 2: Formatting
        toolbar2 = Adw.Clamp()
        toolbar2_box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL)
        toolbar2_box.set_spacing(8)
        toolbar2_box.set_homogeneous(False)
        
        # Text style group
        text_style_group = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL)
        text_style_group.add_css_class("toolbar-group")
        text_style_group.set_spacing(2)
        
        # Create a separator between button groups
        separator1 = Gtk.Separator(orientation=Gtk.Orientation.VERTICAL)
        separator1.add_css_class("toolbar-separator")
        
        # Text formatting group
        text_format_group = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL)
        text_format_group.add_css_class("toolbar-group")
        text_format_group.set_spacing(2)
        ...
        list_group = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL)
        list_group.add_css_class("toolbar-group")
        list_group.set_spacing(2)
        ...
        # Color group
        color_group = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL)
        color_group.add_css_class("toolbar-group")
        color_group.set_spacing(2)
        
        toolbar2_box.append(text_style_group)
        toolbar2_box.append(separator1)
        toolbar2_box.append(text_format_group)
        toolbar2_box.append(separator2)
        toolbar2_box.append(list_group)
        toolbar2_box.append(separator3)
        toolbar2_box.append(color_group)
        
        toolbar2.set_child(toolbar2_box)
        toolbars_container.append(toolbar2)
        
        toolbar_view.set_content(toolbars_container)
        ...
        toolbar_view.add_bottom_bar(scroll)
        self.webview.load_html(self.initial_html, "file:///")
        
        # --- Populate Toolbar1 Groups ---
        # File group buttons
        for (icon, handler) in [
        ...
        # Add zoom dropdown to view group
        ...
        # Dark mode button in view group
        ...
        # --- Populate Toolbar2 Groups ---
        # Text style group: Heading and font dropdowns
        ...
        # Text format group: Bold, italic, etc.
        ...
        text_format_group.append(self.align_dropdown)
        
        # List group: Bullets, numbering, indentation
        ...
        # Color group: Text and background color
